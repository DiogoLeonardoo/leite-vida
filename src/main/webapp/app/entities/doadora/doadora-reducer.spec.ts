...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, partialUpdateEntity, reset, updateEntity } from './doadora.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_DOADORA_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_DOADORA actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_DOADORA actions', async () => {
      const arg = { id: 25923 };
    ...
    it('dispatches UPDATE_DOADORA actions', async () => {
      const arg = { id: 25923 };
    ...
    it('dispatches PARTIAL_UPDATE_DOADORA actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_DOADORA actions', async () => {
      const arg = 42666;
