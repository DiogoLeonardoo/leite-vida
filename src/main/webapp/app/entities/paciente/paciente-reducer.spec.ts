...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, partialUpdateEntity, reset, updateEntity } from './paciente.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_PACIENTE_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_PACIENTE actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_PACIENTE actions', async () => {
      const arg = { id: 1591 };
    ...
    it('dispatches UPDATE_PACIENTE actions', async () => {
      const arg = { id: 1591 };
    ...
    it('dispatches PARTIAL_UPDATE_PACIENTE actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_PACIENTE actions', async () => {
      const arg = 42666;
