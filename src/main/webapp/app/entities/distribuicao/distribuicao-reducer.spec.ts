...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_DISTRIBUICAO_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_DISTRIBUICAO actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_DISTRIBUICAO actions', async () => {
      const arg = { id: 24603 };
    ...
    it('dispatches UPDATE_DISTRIBUICAO actions', async () => {
      const arg = { id: 24603 };
    ...
    it('dispatches PARTIAL_UPDATE_DISTRIBUICAO actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_DISTRIBUICAO actions', async () => {
      const arg = 42666;
