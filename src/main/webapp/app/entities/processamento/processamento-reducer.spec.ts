...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_PROCESSAMENTO_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_PROCESSAMENTO actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_PROCESSAMENTO actions', async () => {
      const arg = { id: 22977 };
    ...
    it('dispatches UPDATE_PROCESSAMENTO actions', async () => {
      const arg = { id: 22977 };
    ...
    it('dispatches PARTIAL_UPDATE_PROCESSAMENTO actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_PROCESSAMENTO actions', async () => {
      const arg = 42666;
