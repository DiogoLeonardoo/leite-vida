...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, partialUpdateEntity, reset, updateEntity } from './coleta.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_COLETA_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_COLETA actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_COLETA actions', async () => {
      const arg = { id: 19493 };
    ...
    it('dispatches UPDATE_COLETA actions', async () => {
      const arg = { id: 19493 };
    ...
    it('dispatches PARTIAL_UPDATE_COLETA actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_COLETA actions', async () => {
      const arg = 42666;
